...
import type { IBridgeTx, IHubBridgeTransaction } from '../../src/interfaces/bridge_tx.ts';
import type { IClaimTx, IHubClaimTransaction } from '../../src/interfaces/claim_tx.ts';
import type {
...
import type { IMappingTx, IHubTokenMappings } from '../../src/interfaces/token_mapping.ts';
