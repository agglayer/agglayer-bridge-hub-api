...
import type { ClaimProofQuery } from "../src/schemas";
...
export const mockTransaction: IHubTransaction = {
	...
	depositCount: 42,
	bridgeHash: "0xbridgehash",
	txSender: "0xsender",
	claimTransactionHash: "0xclaimhash",
	claimBlockNumber: 12346,
	claimTimestamp: 1700001000,
...
// Mock mappings
export const mockMapping: IHubTokenMappings = {
	blockNumber: 12345,
	transactionIndex: 1,
	timestamp: 1700000000,
...
// Mock proof
export const mockProof: ClaimProof = {
